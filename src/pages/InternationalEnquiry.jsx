...
const InternationalEnquiry = () => {
  useEffect(() => {
    document.title = "International Enquiry - Glareen USA";
  }, []);
  const TESTIMONIALS = [
    {
      ...
      name: "Mayank yadav",
      location: "Punjab",
      img: "https://glareen.in/cdn/shop/files/WhatsApp_Image_2025-04-01_at_9.37.26_PM.jpg?v=1743525845",
      stars: 5,
    },
    {
      ...
      name: "Ankita jaiswal",
      location: "Delhi",
      img: "https://glareen.in/cdn/shop/files/WhatsApp_Image_2025-04-01_at_9.37.28_PM.jpg?v=1743525532",
      stars: 5,
    },
    {
      ...
      name: "Neha Gupta",
      location: "Bangalore",
      img: "https://glareen.in/cdn/shop/files/WhatsApp_Image_2025-04-01_at_9.37.27_PM.jpg?v=1743525431",
      stars: 5,
    },
    {
      ...
      name: "Ajay Singh",
      location: "Hyderabad",
      img: "https://glareen.in/cdn/shop/files/WhatsApp_Image_2025-04-01_at_9.37.25_PM_1.jpg?v=1743525677",
      stars: 5,
    },
    {
      ...
      name: "Preeti Panday",
      location: "Delhi",
      img: "https://glareen.in/cdn/shop/files/WhatsApp_Image_2025-04-01_at_9.37.26_PM_1.jpg?v=1743525745",
      stars: 5,
    },
  ];
  ...
  return (
    <>
      <div>
        <img
          src="https://cdn.shopify.com/s/files/1/0610/3072/7749/files/Background_7.png?v=1744460118"
          alt="international-enquiry-banner"
        />
        <EnquirySection enquiryType="international" />
      </div>
...
export default InternationalEnquiry;
