        ...
        <div className="mt-12 space-y-8 text-[15px] leading-7 text-gray-700">
          ...
          <Section title="Order Tracking">
            <p>
              ...
              email or through your Amazon account. Tracking updates may take up
          ...
          <Section title="Contact Us">
            <p>
              For general shipping questions related to our products, contact us
              at{" "}
              <a href="mailto:market@glareen.com" className="underline">
                market@glareen.com
              </a>
              .
            </p>
